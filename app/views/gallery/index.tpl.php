        ...
        <section class="list">
            <div class="list__container">
                <div class="list__head-wrapper">
                    <a href="<?= PATH . get_lang_path() ?>" title="<?= $translation_gallery[$_SESSION['lang']]['tooltip'] ?>">
                    ...
                    <h2 class="list__label"><?= $translation_gallery[$_SESSION['lang']]['gallery'] ?></h2>
                </div>
                <ul class="list__items-wrapper">
                    <?php foreach ($folders as $folder) : ?>
                        <li class="list__item gallery-item preview">
                            <a href="<?= PATH . get_lang_path() . '/gallery' . '/' . $folder['name'] ?>" style="background-image: url(<?= './img/gallery/' . $folder['name'] . '/' . $folder['preview']['small'] ?>);" class="list__item-link blurred">
                                <img
                                    class="post__img"
                                    loading="lazy"
                                    src="<?= './img/gallery/' . $folder['name'] . '/' . $folder['preview']['medium'] ?>"
                                    alt="Featured Post Image" />
                                <h4 class="list__item-title"><?= $folder['name'] ?></h4>
                            </a>
                        </li>
                    <?php endforeach; ?>
                </ul>
