<?php
$translation_posts_show = [
    'en' => [
        'latest_posts' => 'Latest Posts',
        'tooltip' => 'Back to all posts',
    ],
    'cs' => [
        'latest_posts' => 'Poslední příspěvky',
        'tooltip' => 'Zpět na všechny příspěvky',
    ],
    'ru' => [
        'latest_posts' => 'Последние посты',
        'tooltip' => 'Вернуться ко всем постам',
    ],
]
        ...
        <section class="list">
            <div class="list__container">
                <div class="list__head-wrapper">
                    <a href="<?= PATH . get_lang_path() . '/posts' ?>" title="<?= $translation_posts_show[$_SESSION['lang']]['tooltip'] ?>">
                    ...
                    <h2 class="list__label"><?= $translation_posts_show[$_SESSION['lang']]['latest_posts'] ?></h2>
                </div>
